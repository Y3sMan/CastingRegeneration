...
const pwd = "G:/Games/MO Instances/Enderal/overwrite";


// Configure webpack output file folder and file name
const outputFolder = path.resolve(pwd, './build')
const outputFilename = `${packageInfo.name}.js`

// Configure entry point of application.
// This should be a .ts file, e.g. not dist/CastingRegeneration.js
const entryPoint = './src/CastingRegeneration.ts'
